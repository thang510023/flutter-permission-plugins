...
[![pub package](https://img.shields.io/pub/v/camera_permissions.svg)](https://pub.dartlang.org/packages/camera_permissions)
...
To use this plugin, add `camera_permissions` as a [dependency in your pubspec.yaml file](https://flutter.io/platform-plugins/). For example:

```yaml
dependencies:
  camera_permissions: ^2.0.5
```

> **NOTE:** The camera_permissions plugin uses the AndroidX version of the Android Support Libraries. This means you need to make sure your Android project is also upgraded to support AndroidX. Detailed instructions can be found [here](https://flutter.dev/docs/development/packages-and-plugins/androidx-compatibility).
>
